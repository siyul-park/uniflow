...
func TestAddToScheme(t *testing.T) {
	...
	tests := []string{KindBlock, KindFork, KindIf, KindLoop, KindMerge, KindNOP, KindPipe, KindReduce, KindRetry, KindSequential, KindSession, KindSnippet, KindSplit, KindSwitch, KindWait}
